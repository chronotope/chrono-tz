//! # Chrono-TZ 0.4.1
//!
//! `Chrono-TZ` is a library that provides timezone types with metadata and
//! implementors of the [`TimeZone`][timezone] trait for
//! [`rust-chrono`][chrono]. The types and impls are generated by a build
//! script using the [`IANA database`][iana] and
//! [`zoneinfo_parse`][zoneinfo_parse].
//!
...
//!
//! ```
#![cfg_attr(feature = "chrono", doc = "extern crate chrono;")]
...
pub use timezone_impl::OffsetName;
